...
public class ClienteChat2 extends JFrame implements ActionListener, Runnable {
	...
	// constructor
	public ClienteChat2(Socket s, String nombre) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			ClienteChat2 cliente = new ClienteChat2(s, nombre);
